...
4. urgent = true, если в тексте есть явный дедлайн/срочность:
   «срочно», «сегодня», «завтра», «до завтра», «ASAP», конкретное время «в N утра/вечера» с близкой датой.
   Иначе urgent = false.
5. Если категория неоднозначна — выбери наиболее вероятную. Никогда не выдумывай другие поля или значения.
""".strip()
